...
const TShoes = () => {
    ...
    const getData = () => {
        ...
        let Url = "http://localhost:3002/Shoes";
        axios.get(Url)
            .then(response => updateProduct(response.data))

    }
    const deleteData = (pid) =>{
        axios.delete("http://localhost:3002/Shoes/"+pid)
        .then(response=>{
    ...
    return (
        <div>
                            ...
                            <table className="table table-bordered text-center">
                                ...
                                <tr><th colSpan="9"><h6 className="text-center">Shoes</h6></th></tr>
                                    <tr className="font">
                                        <th>S.No</th>
                                        <th>P.Name</th>
                                        <th>M.name</th>
                                        ...
                                        <th>A.Stock</th>
                                        <th>Price</th>
                                        <th><Link to="/shoesform"><i className="fa fa-plus fa-m"></i></Link></th>
                                        <th>Edit</th>
                                        <th>Delete</th>
                                    </tr>
                                </thead>
                        ...
                        return(
                                    <tr key={index}>
                                     <td>{xpro.id}</td>
                                        ...
                                        <td>{xpro.Stock}</td>
                                        <td>{xpro.Price}</td>
                                        <td><Link to="/shoesform"><i className="fa fa-plus fa-m"></i></Link></td>
                                        <td><Link to="/shoes"><i className="fa fa-edit"></i></Link></td>
